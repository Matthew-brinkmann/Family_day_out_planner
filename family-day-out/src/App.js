...
function App() {
  ...
  const searchClick = () => {
    ...
    fetch("http://0.0.0.0:5005/api/event_information", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="container">
      ...
      />
      <EventItem
        title={events_results[0].title}
        event_date={events_results[0].date.when}
        event_address={events_results[0].address[0]}
        event_address_sub={events_results[0].address[1]}
        event_image={events_results[0].image}
        description={events_results[0].description}
        event_link={events_results[0].link}
        event_location_image={events_results[0].event_location_map.image}
        event_location_direction={events_results[0].event_location_map.link}
      />
      <EventItem
        title={events_results[1].title}
        event_date={events_results[1].date.when}
        event_address={events_results[1].address[0]}
        event_address_sub={events_results[1].address[1]}
        event_image={events_results[1].image}
        description={events_results[1].description}
        event_link={events_results[1].link}
        event_location_image={events_results[1].event_location_map.image}
        event_location_direction={events_results[1].event_location_map.link}
      />
